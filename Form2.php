...
if(isset($_POST['submit'])){
    $subject = "Concepts of Machine Learning Lab";
...
<head>
    <title>Concepts of Machine Learning Lab</title>
                ...
                <div class="feedback-form">
                    <table class="title">
                        ...
                        <tr>
                            ...
                            <td>Subject Name:</td>
                            <td>Concepts of Machine Learning Lab</td>
                        </tr>
                        <tr>
                            <td>Faculty Name:</td>
                            <td>Prof. Dr. Ankur Chaudhary</td>
                            <td>Subject Code:</td>
                            <td>CAL201</td>
                        </tr>
                    </table>
